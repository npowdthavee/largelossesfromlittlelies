...
cibar decision, barg(35) over1(m2) graphopts(ylabel(0(.2)1) yscale(range(0 1)) ymtick(0(.2)1) xtitle("Conditions") ytitle("Mean Steal in the Golden Balls Game"))  barcol (gs5 gs6 gs7 gs8 gs9 gs10 gs11 gs12)

 
//Main probitressions 
char treatment[omit] 0
probit decision i.true_gender  i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store ALL0


char treatment[omit] 0
probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3    , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store ALL

char treatment[omit] 0
probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust    , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
...
probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing age age_sq econ i.location  timeokprisonersdilemmaok  risk   if (gender_pairing==0 | gender_pairing == 3) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store gender0

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   if (gender_pairing==1 | gender_pairing == 2) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store gender1

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   if (gender_pairing==0) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store gender2

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing age age_sq econ i.location  timeokprisonersdilemmaok  risk   if (gender_pairing==1) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store gender3

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   if (gender_pairing==2) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store gender4

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk  if (gender_pairing==3) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store gender5


**Male vs Female

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing age age_sq econ i.location  timeokprisonersdilemmaok  risk   if (gender==1) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store male

probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing age age_sq econ i.location  timeokprisonersdilemmaok  risk  if (gender==0) , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
...
coefplot ALL0  , bylabel(All, N=966) || male , bylabel(Male, N=449) || female , bylabel(Female, N=517) ||, /*
*/ drop(_cons _Igend*  econ location  timeokprisonersdilemmaok person* pc1 pc2  rk*) nolabel /*
*/  xline(0) xtitle("Marginal effect on the decision to steal") byopts(compact cols(1)) levels(95)   


//paired decision
 
mprobit paired_decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.catfish4 i.catfish5 i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
estimates store J

coefplot J  ,   /*
*/ drop(_cons _Igend*  econ location  timeokprisonersdilemmaok person* pc1 pc2  rk*) nolabel  /*
*/     xline(0) fcolor(*.5) xtitle("Marginal effect on the pairing decision") byopts(compact cols(1)) levels(95)   



**Predicting catfish

probit catfish3   gender  age age_sq econ i.location  timeokprisonersdilemmaok  risk  pc1 pc2   if misrep>=2 & misrep<=3, r
margins r.true_gender  r.catfish1  r.catfish2  r.catfish3 r.catfish4 r.catfish5 r.catfish6, post atmean
...
xi:dprobit zero i.m2 i.gender_pair age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r

xi:dprobit max_payment i.m2 i.gender_pair age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
...
probit decision i.true_gender i.catfish1 i.catfish2 i.catfish3 i.gender inter_cat3 i.catfish4 i.catfish5  i.catfish6  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
...
xi:dprobit decision i.true_gender i.catfish1 i.catfish2 i.catfish3*i.gender    inter_cat3 i.catfish4 i.catfish5  i.catfish6  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r	

outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS2.xls", replace  

xi:dprobit decision i.control i.catfish1 i.catfish2 i.catfish3*i.gender    inter_cat3 i.catfish4 i.catfish5  i.catfish6  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r	

outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS2.xls", append
...
gen catfish_ITT = 0
replace catfish_ITT = 1 if m3==3
*gen inter_ITT_gender = catfish_ITT*gender 
*gen true_gender_gender = true_gender*gender

*probit decision i.true_gender   i.catfish1 i.catfish2 i.catfish_ITT i.catfish5  i.catfish6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r

xi:probit decision i.m3 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r

probit decision  i.true_gender i.catfish1 i._Im3_3 i.catfish4 i._Im3_6 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r

margins  r.true_gender r.catfish1 r._Im3_3 r.catfish4 r._Im3_6 , post atmean
...
**Table S1.
char m2[omit] 0
xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS1.xls", replace  

char m2[omit] 1
xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS1.xls", append  


**Intention to treat
char m3[omit] 1
xi:dprobit decision i.m3 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS1.xls", append
...
char m3[omit] 0
xi: dprobit decision i.m3 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS3.xls", replace
char m3[omit] 1
xi:dprobit decision i.m3 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS3.xls", append
...
char m2[omit] 0
xi:dprobit max_payment i.m2 i.gender_pair age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS4.xls", replace

char m2[omit] 1
xi:dprobit max_payment i.m2 i.gender_pair age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS4.xls", append

char m3[omit] 0
xi:dprobit max_payment i.m3 i.gender_pair age age_sq econ i.location  timeokprisonersdilemmaok  risk   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS4.xls", append
...
char treatment[omit] 0
xi:dprobit decision i.true_gender i.m2 i.gender_pairing age age_sq  econ i.location  timeokprisonersdilemmaok   risk    if location==0, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS4.xls", replace
 
char treatment[omit] 0
xi:dprobit decision i.true_gender i.m2 i.gender_pairing age age_sq  econ i.location  timeokprisonersdilemmaok   risk   if location==1, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS4.xls", append
 
char treatment[omit] 0
xi:dprobit decision i.true_gender i.m2 i.gender_pairing age age_sq  econ i.location  timeokprisonersdilemmaok   risk   if location==2, r
 outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS4.xls", append


*Fig S4.
coefplot ALL0 ALL ALL1 , bylabel(All, N=966) ||  , /*
*/ drop(_cons _Igend*  econ location  timeokprisonersdilemmaok person* pc1 pc2  rk*) /*
*/  xline(0) xtitle("Marginal effect on the decision to steal") byopts(compact cols(1)) levels(95)   plotlabels("Without dark traits" "+ dark triad traits" "+dark traits & general trust")



**By country regressions 
coefplot UK0  , bylabel(United Kingdom (lab), N=338) || SG0 , bylabel(Singapore (lab), N=348) ||  OL0 , bylabel(UK/US (online), N=280) ||,/*
*/ drop(_cons _Igend*  econ location  timeokprisonersdilemmaok person* pc1 pc2  rk*) nolabel  /*
*/  xline(0) xtitle("Marginal effect on the decision to steal") byopts(compact cols(1)) levels(95)  
...
*Fig S5.
coefplot  gender0, bylabel(Same gender, N=492) || gender1 , bylabel(Opposite gender, N=474) || /*
*/ gender2, bylabel(Both males, N=212) || gender3 , bylabel(Female matched with male, N=237) || /*
*/ gender4 , bylabel(Male matched with female, N=237) || gender5 , bylabel(Both females, N=280) || , /*
*/ drop(_cons _Igend*   econ location  timeokprisonersdilemmaok person* pc1 pc2  rk*) /*
...
xi:dprobit c_outcome gender age age_sq  econ i.location   , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS6.xls", replace

xi:dprobit c_outcome gender age age_sq  econ i.location  risk trust  fc1 fc2 fc3, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Preparing manuscript/TableS6.xls", append
