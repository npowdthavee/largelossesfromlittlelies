**Preparing for PLOS ONE submission
...
**Simplify gender pairing
gen gp = gender_pairing
lab def gp 0 "M matched with M" 1 "F matched with M" 2 "M matched with F" 3 "F matched with F", modify
lab val gp gp

lab def treat 0 "Blind" 1 "True Gender" 2 "Randomised Opportunity" 3 "Randomised Gender", modify
lab val treat treat

save  "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/catfish_final_june2020.dta", replace


**REGRESSION


use "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/catfish_final_june2020.dta", clear

 drop if age<18
 
**Table 1: Descriptive statistics
  gen misrepresent_ = 0 if m2>2 & m2<=4
  replace misrepresent_ = 1 if m2==4
  sort location
  by location: su misrepresent_
  
xi:asdoc sum decision payment gender age econ risk trust misrepresent_ person*  /*
*/ , by(location) stat(N mean semean min max) save(/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos one/mydoc1.doc) replace 

xi:asdoc sum decision payment gender age econ risk trust misrepresent_ person*  /*
*/ ,  stat(N mean semean min max) save(/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos one/mydoc2.doc) replace 

*ranksum decision if (m3 == 0 | m3 == 3), by(m3)
*ranksum decision if (m3 == 1 | m3 == 3), by(m3)

**CIBAR by treatment
cibar decision, over(treat)

**CIBAR by treatment and gender pairing
cibar decision, over1(treat) over2(gp)

**CIBAR by treatment and location
cibar decision, over1(treat) over2(location)


lab def m2_ 0 "B" 1 "TG" 2 "RAO1" 3 "RAO2" 4 "RAO3" 5 "RAG1" 6 "RAG2" 7 "RAG3"
lab val m2 m2_ 
...
cibar decision, over1(m3)   graphopts(ylabel(0(0.1)0.6) yscale(range(0 0.6)) ymtick(0(0.1)0.6) xtitle("Conditions") ytitle("Average steal rates")) 

graph save "Graph" "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Steal rate.gph", replace
graph save "Graph" "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Steal rate.png", replace

**Table 2: Treatment effects
char treatment[omit] 0
xi:dprobit decision i.treat i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table2_Sept22.xls", replace

char treatment[omit] 1
xi:dprobit decision i.treat i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table2_Sept22.xls", append
...
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table2_Sept22.xls", append
**Table 3: Unpacking the treatment

char m2[omit] 0
xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table3_Sept22.xls", replace

test _Im2_4 == _Im2_1
test _Im2_4 == _Im2_3
test _Im2_4 == _Im2_2

xi:dprobit  decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust if gender==0, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table3_Sept22.xls", append 

test _Im2_4 == _Im2_1
test _Im2_4 == _Im2_3
test _Im2_4 == _Im2_2

xi:dprobit  decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust if gender==1, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table3_Sept22.xls", append 
...
**Table 4: Gender pairing by gender
*Same sex
xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust if gender==0 & gender_pairing==3, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table4_Sept22.xls", replace

test _Im2_4 == _Im2_1
test _Im2_4 == _Im2_3
test _Im2_4 == _Im2_2

xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust if gender==1 & gender_pairing==0, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table4_Sept22.xls", append
...
*Mixed sex
xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust if gender==0 & gender_pairing==1, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table4_Sept22.xls", append 
...
xi:dprobit decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust if gender==1 & gender_pairing==2, r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table4_Sept22.xls", append 
...
**Paired decision regressions
char treatment[omit] 0
xi:mprobit paired_decision i.treat i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table5_Sept22.xls", replace

margins, dydx(_Itreatment_1 _Itreatment_2 _Itreatment_3)  


xi:mprobit paired_decision i.m2 i.gender_pairing  age age_sq econ i.location  timeokprisonersdilemmaok  risk fc1 fc2  fc3 trust , r
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Golden ball/Submission/Plos One/Table5_Sept22.xls", append

margins, dydx(_Im2_1 _Im2_2 _Im2_3 _Im2_4 _Im2_5 _Im2_6 _Im2_7) 
 
xi:dprobit c_outcome i.gender_pairing age age_sq  econ i.location  risk fc1 fc2 fc3 trust  , 
